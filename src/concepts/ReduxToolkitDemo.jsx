  ...
  return (
    <div className="demo-section">
      ...
      <p>
        ...
        This component uses Redux Toolkit for state management with a simple counter.
      </p>
      <p>
        <strong>Usage:</strong> <br />
        It uses <code>useSelector</code> to access state and <code>useDispatch</code> to update the state via actions.
      </p>
      <p>Count: {count}</p>
